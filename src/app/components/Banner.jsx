...
const Banner = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center mt-1 p-6 md:p-12">
      <div className="max-w-lg text-center md:text-left space-y-4">
        <h1 className="text-4xl mb-10 md:text-5xl font-bold text-green-950 leading-tight">
